...
public class Level_1 extends Scene {
    ...
    public Level_1()
    {
        ...
        try
        {
            ...
            LevelLoader levelLoader1 = new LevelLoader("LevelLoader", this, 3);
            levelLoader1.getTransform().setLocation(new Vector2(300, 60));
            AddGameObject(levelLoader1);
        }
    ...
    {
        super.dispose();
        new Writer("45","highscore_1","highscore.txt");
